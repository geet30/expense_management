                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            {!! Form::model($target, ['method' => 'PATCH','route' => ['targets.update', $target->id],'id'=>'addCategory']) !!}
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('profile_id',$bidProfile,$target->profile_id, array('class' => 'form-control','placeholder' => 'Profile Id')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                  ...
                                  <input type="radio" id="type" name="type" class="custom-control-input" checked value="Fixed" {{ isset($target->type) && $target->type == 'Fixed' ? 'checked' : ''}}>
                                  <label class="custom-control-label" for="type">Fixed</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                  <input type="radio" id="type2" name="type" class="custom-control-input" value="Hourly" {{ isset($target->type) && $target->type == 'Hourly' ? 'checked' : ''}}>
                            ...
                            <div class="show_types">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                        ...
                                        {!! Form::select('minutes',$minutes,$target->minutes, array('class' => 'form-control minutes','placeholder' => 'Minutes')) !!}
