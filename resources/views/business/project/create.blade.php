                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            {!! Form::open(array('route' => 'projects.store','method'=>'POST','id'=>'addCategory')) !!}
                            @csrf
                           ...
                           <div class="form-group">
                                ...
                                {!! Form::select('contract_type',$contact_types,[], array('class' => 'form-control','placeholder' => 'Contract type')) !!}
                             ...
                             <div class="form-group">
                                ...
                                {!! Form::select('project_type',$project_types,[], array('class' => 'form-control','placeholder' => 'Project type')) !!}
                             ...
                             <div class="form-group">
                                ...
                                {!! Form::text('start_date', null, array('placeholder' => 'Start Date','class' => 'form-control','id'=>'datepicker')) !!}
                             ...
                             <div class="form-group">
                                ...
                                {!! Form::text('end_date', null, array('placeholder' => 'End Date','class' => 'form-control','id'=>'datepicker2')) !!}
